...
class Book extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('title, author, isbn, publisher, edition, keywords, image', 'length', 'max'=>128),
			array('number_of_pages', 'length', 'max'=>45),
			array('date_edition, abstract, create_time, update_time', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, booktype_id, subject_id, condition_id, format_id, title, author, isbn, number_of_pages, publisher, edition, date_edition, keywords, abstract, image, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
